<body>
    <div class="product-container">
      <div class="image">
        <img src="https://i.ibb.co/0JKpmgd/blue.png" alt="OFF-white Red Edition" border="0" />
      </div>
      <div class="details">
        <h2 class="cost">$1599</h2>
        <p class="title">Air Jordan 1 Retro High "Off-White - UNC" sneakers</p>
      </div>
    </div>
